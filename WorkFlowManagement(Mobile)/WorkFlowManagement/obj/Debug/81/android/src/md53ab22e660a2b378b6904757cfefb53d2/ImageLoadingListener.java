...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onLoadingCancelled:(Ljava/lang/String;Landroid/view/View;)V:GetOnLoadingCancelled_Ljava_lang_String_Landroid_view_View_Handler:UniversalImageLoader.Core.Listener.IImageLoadingListenerInvoker, UniversalImageLoader\n" +
			...
			"";
		mono.android.Runtime.register ("UniversalImageLoader.Core.Listener.ImageLoadingListener, UniversalImageLoader", ImageLoadingListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ImageLoadingListener.class)
			mono.android.TypeManager.Activate ("UniversalImageLoader.Core.Listener.ImageLoadingListener, UniversalImageLoader", "", this, new java.lang.Object[] {  });
	}
