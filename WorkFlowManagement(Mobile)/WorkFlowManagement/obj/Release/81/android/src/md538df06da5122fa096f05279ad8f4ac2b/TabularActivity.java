...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WorkFlowManagement.Activities.TabularActivity, WorkFlowManagement", TabularActivity.class, __md_methods);
	}


	public TabularActivity ()
	{
		super ();
		if (getClass () == TabularActivity.class)
			mono.android.TypeManager.Activate ("WorkFlowManagement.Activities.TabularActivity, WorkFlowManagement", "", this, new java.lang.Object[] {  });
	}
